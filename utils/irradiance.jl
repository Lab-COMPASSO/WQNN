...
function get_total_irradiance(surface_tilt::Float64, surface_azimuth::Int64, solar_zenith::Float64, solar_azimuth::Float64,
    dni::Float64, dhi::Float64, ghi::Float64, albedo::Float64)::Float64
...
function aoi(surface_tilt::Float64, surface_azimuth::Int64, solar_zenith::Float64, solar_azimuth::Float64)::Float64
    projection = (
...
function get_sky_diffuse(surface_tilt::Float64, dhi::Float64)::Float64
    # isotropic
...
function get_ground_diffuse(surface_tilt::Float64, ghi::Float64, albedo::Float64)::Float64
